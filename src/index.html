...
<body>
    <div class="navBar bg-dark fixed-top">
        <div class="navBar__container container">
            <nav class="row navbar navbar-dark navbar-expand-lg">
                <a href="#" class="navBar__container__logo navbar-brand"><img src="./img/IDDO.svg" alt=""></a>
                ...
                <div class="tab-content pt-5" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-all" role="tabpanel" aria-labelledby="pills-all-tab">
                        <div class="cards d-flex flex-row justify-content-around flex-wrap">
                            <button class="cards__item card text-center mb-5" type="button" data-toggle="modal" data-target=".newModal1">
                            <!--HOTFIX: modal bootstrap onli works in safari cart isn in button -->
                                <div>
                                    <p class="cards__item--image card-img-top img-fluid"></p>
                                    <div class="cards__item--text card-block mt-4">
                                        <h5 class="card-title text-primary font-weight-bold">Name preject</h5>
                                        <p class="cards__item--text text-14px text-gray-500 card-text font-weight-light">designed by Authour | May 23, 2014 </p>
                                    </div>
                                </div>
                            </button>
                            <button class="cards__item card text-center mb-5" type="button" data-toggle="modal" data-target=".newModal1">
    ...
    <footer class="container-fluid bg-gray-900 text-center d-flex flex-column">
        <a href="#" class=" pt-5 mt-4 pb-4 mb-2"><img src="./img/IDDO.svg" alt=""></a>
        <p class=" text-white text-14px text-gray-500"> &#174; 2014 IDDO. All rights resevered.<br> Designed by DZOAN. </p>
        <a class="mb-4" href="#">
